...
export default function Dashboard() {
  ...
  return (
    <div className={`${isSidebarOpen ? 'overflow-hidden md:overflow-visible' : ''} min-h-[100dvh] md:min-h-[100dvh] bg-white flex flex-col md:flex-row`}>
      {isSidebarOpen && (
        <div className="fixed inset-0 bg-black/20 z-30 md:hidden" onClick={() => setIsSidebarOpen(false)} />
      )}
      {/* Sidebar */}
      <div className={`bg-gray-50 md:border-r border-b border-gray-200 flex flex-col overflow-y-auto overscroll-contain md:overscroll-auto md:overflow-y-auto md:static fixed inset-y-0 left-0 z-40 w-64 md:w-64 min-h-[100dvh] md:min-h-[100dvh] lg:min-h-[100dvh] transform transition-transform duration-200 md:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}> 
        {/* Logo */}
      ...
      <div className="flex-1 flex flex-col bg-white min-h-[100dvh]">
        ...
        <div className="bg-white px-4 sm:px-6 py-3 sm:py-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <button className="sm:hidden p-2 -ml-2 rounded-lg hover:bg-gray-100 text-gray-600" onClick={() => setIsSidebarOpen(true)}>
                <PanelLeft className="w-5 h-5" />
              </button>
          ...
          <div className="mt-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            ...
            <div className="flex items-center gap-2">
              <button className="flex items-center gap-2 text-sm text-gray-700 border border-gray-200 rounded-md px-3 py-2 bg-white whitespace-nowrap">
        ...
        <div className="flex-1 p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6 bg-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-3 lg:gap-6 bg-transparent auto-rows-max">
            {/* Current Tickets */}
            <div className="bg-gray-100 rounded-xl border border-gray-200 p-2 shadow-sm flex flex-col h-auto sm:h-[160px] md:h-[180px] col-span-1">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-2 sm:p-3 flex-1 flex flex-col justify-end">
                <div className="text-lg sm:text-xl md:text-xl font-bold text-gray-900 tracking-tight mb-1 sm:mb-2">3,484</div>
                <div className="flex items-center justify-between">
            ...
            <div className="bg-gray-100 rounded-xl border border-gray-200 p-2 shadow-sm flex flex-col h-auto sm:h-[160px] md:h-[180px] col-span-1">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-2 sm:p-3 flex-1 flex flex-col justify-end">
                <div className="text-lg sm:text-xl md:text-xl font-bold text-gray-900 tracking-tight mb-1 sm:mb-2">486</div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center text-xs sm:text-sm">
            ...
            <div className="bg-gray-100 rounded-xl border border-gray-200 p-2 shadow-sm flex flex-col h-auto sm:h-[160px] md:h-[180px] col-span-1 sm:col-span-2 md:col-span-2 lg:col-span-1">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-2 sm:p-3 flex-1 flex flex-col justify-end">
                <div className="text-lg sm:text-xl md:text-xl font-bold text-gray-900 tracking-tight mb-1 sm:mb-2">92%</div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center text-xs sm:text-sm">
            ...
            <div className="bg-gray-100 rounded-xl border border-gray-200 p-2 shadow-sm h-[340px] sm:h-[330px] md:h-[360px] lg:h-[655px] flex flex-col col-span-1 sm:col-span-2 md:col-span-2 lg:col-span-1 lg:row-span-2">
              <div className="flex items-center justify-between mb-2 sm:mb-3 pl-2 sm:pl-3">
            ...
            <div className="bg-gray-100 rounded-xl border border-gray-200 p-2 shadow-sm h-[280px] sm:h-[330px] md:h-[360px] lg:h-[450px] flex flex-col col-span-1 sm:col-span-2 md:col-span-2 lg:col-span-3">
              <div className="flex items-center justify-between mb-2 sm:mb-3 pl-2 sm:pl-3">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-2 sm:p-3 flex-1 flex flex-col overflow-hidden">
                <div className="mb-2 sm:mb-3 flex items-baseline gap-2 sm:gap-3 whitespace-nowrap">
                  <div className="text-xl sm:text-2xl md:text-2xl font-bold text-gray-900 tracking-tight">4,790</div>
                ...
                <div className="flex-1 min-h-0">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={ticketVolumeData} margin={{ right: 24 }}>
                      <XAxis dataKey="day" axisLine={false} tickLine={false} interval={1} minTickGap={8} tickMargin={6} tick={{ fontSize: 10 }} />
